...
urlpatterns = [
    ...
    # logout
    path('logout_user', main.logout_user, name='logout_user'),
    ...
    #PickupAddress
    path('pickform/',main.PickForm),
    path('pickupaddress/',main.DisplayPickupAddress),
    path('updatepickaddress/<id>',main.UpdatePickAddress),
    path('deletepickaddress/<id>',main.DeletePickAddress),
