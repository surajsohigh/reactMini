...
from .models import Address,Product, Order, PickAddress

class AddressForm(forms.ModelForm):
	class Meta:
		model=Address
		fields= ('name', 'address', 'country', 'state', 'city', 'pincode', 'phone', 'email',)
...
class PickFormData(forms.ModelForm):
	class Meta:
		model=PickAddress
		fields= ('name', 'address', 'country', 'state', 'city', 'pincode', 'phone', 'email',)
...
class ProductForm(forms.ModelForm):
	class Meta:
		model=Product
		fields= ('name', 'price', 'sku', 'hsn', 'weight', 'length', 'breadth', 'height',)
